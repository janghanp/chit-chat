...
const Sidebar = () => {
	...
	return (
		<>
			...
			<div className={`absolute left-0 right-0 top-[10px] z-10 block border-b pl-3 shadow-md md:hidden`}>
				<button className="btn-ghost btn-sm btn btn-square" onClick={() => setIsSidebarOpen(!isSideBarOpen)}>
